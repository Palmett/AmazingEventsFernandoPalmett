...
for (let i = 0; i < datos_constantes.eventos.length; i++) {
    let tarjeta = document.createElement("div")
        tarjeta.className = "card col-sm-5 col-lg-3 col-xl-2  mb-3 mx-1 p-2"
        tarjeta.innerHTML = `
                    <img src="${datos_constantes.eventos[i].imagen}" class="card-img-top h-40 object-fit-cover" alt="${datos_constantes.eventos[i].Categoría}">

                    <div class="card-body d-flex flex-column">
                      <h5 class="card-title "> ${datos_constantes.eventos[i].nombre}</h5>
                      <p class="card-text flex-grow-1"> ${datos_constantes.eventos[i].descripción}</p>
                      <p class="card-text">Date: ${datos_constantes.eventos[i].fecha}</p>
