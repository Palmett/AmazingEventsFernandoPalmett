...
for (let i = 0; i < past_events.length; i++) {
    let tarjeta = document.createElement("div")
        ...
        tarjeta.innerHTML = `
                    <img src="${past_events[i].imagen}" class="card-img-top h-40 object-fit-cover" alt="${past_events[i].Categoría}">

                    <div class="card-body d-flex flex-column">
                      <h5 class="card-title "> ${past_events[i].nombre}</h5>
                      <p class="card-text flex-grow-1"> ${past_events[i].descripción}</p>
                      <p class="card-text">Date: ${past_events[i].fecha}</p>
